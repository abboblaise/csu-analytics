...
domain_names=($NGINX_FRONTEND_DOMAIN_NAME $NGINX_BACKEND_DOMAIN_NAME $NGINX_KEYCLOAK_DOMAIN_NAME $NGINX_MINIO_DOMAIN_NAME $NGINX_CONSOLE_MINIO_DOMAIN_NAME $NGINX_SUPERSET_DOMAIN_NAME $NGINX_SUPERSET_GUEST_DOMAIN_NAME $NGINX_AIRFLOW_DOMAIN_NAME $NGINX_DRUID_DOMAIN_NAME $NGINX_DRUID_COORDINATOR_DOMAIN_NAME $NGINX_FREELLMAPI_CONSOLE_DOMAIN_NAME $NGINX_FREELLMAPI_SERVER_DOMAIN_NAME)
